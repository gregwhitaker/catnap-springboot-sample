...
import com.github.gregwhitaker.catnapspringboot.sample.service.ProductService;
...
@RestController
@RequestMapping(value = "/products/{id}/details")
public class ProductController {
    ...
    public ResponseEntity<?> getProduct(@PathVariable(value = "id") String id) {
        ProductDetails details = service.getProduct(id);
